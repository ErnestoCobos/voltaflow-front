        ...
        <div className="min-h-screen bg-[#1B1B1B] p-6 flex items-center justify-center overflow-hidden">
            ...
            >
                <style jsx>{`
                    ...
                    .tower-top .window:nth-child(1) {
                        left: 10px;
                    }

                    .tower-top .window:nth-child(2) {
                        right: 10px;
                    }
                `}</style>
                ...
                >
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-48 z-10">
                            <div
                                className="absolute bottom-0 left-0 right-0 h-32 bg-[#ffb5b5] rounded-[100%] translate-y-16"/>
                            <div
                                className="absolute bottom-0 left-1/4 right-0 h-24 bg-[#ffc2c2] rounded-[100%] translate-y-8"/>
                    ...
                    <div ref={containerRef}
                         className="absolute bottom-4 left-1/2 -translate-x-1/2 w-[400px] h-[300px] z-30">
                        <div className="absolute left-1/2 bottom-0 -translate-x-1/2">
                            {/* Purple Rectangle */}
                            <div
                                className="absolute -translate-x-20 -translate-y-52 w-24 h-48 bg-[#8E44AD] rounded-lg flex flex-col items-center pt-4">
                            ...
                            {/* Black Rectangle */}
                            <div
                                className="absolute -translate-x-4 -translate-y-40 w-20 h-36 bg-black rounded-lg flex flex-col items-center pt-4">
                                <div className="flex gap-2 relative">
                                    <div className="w-7 h-7 bg-white rounded-full relative overflow-hidden">
                                        <motion.div
                                            className="w-3.5 h-3.5 bg-black rounded-full absolute"
                            ...
                            {/* Yellow Oval */}
                            <div
                                className="absolute translate-x-12 -translate-y-36 w-24 h-32 bg-[#F1C40F] rounded-full flex flex-col items-center justify-center">
                            ...
                            {/* Orange Semicircle */}
                            <div
                                className="absolute -translate-x-8 -translate-y-20 w-32 h-16 bg-[#FFA726] rounded-t-full flex flex-col items-center pt-4">
